...
echo "colcon build --symlink-install && source /workspace/install/setup.bash && ros2 launch custom_ur_moveit_config combined_ur3e.launch.py use_fake_hardware:=false"
echo "docker exec -it demostation-ur3 bash"
echo "python3 /workspace/custom_code/ur3_grip_and_place.py"
echo "docker exec -it demostation-ur3 bash"
echo "python3 /workspace/custom_code/ur3_provide_from_storage.py"
